...
class CourseViewMenuComponent(BaseComponent):
    ...
    @allure.step('Open course menu at index "{index}" and click edit')  # Добавили allure шаг
    ...
    allure.step('Open course menu at index "{index}" and click delete')  # Добавили allure шаг
